...
ggsave("PlotSPYput.png",width = 3840, height = 1080, units = "px")
...
plott <- PdiffSPY %>% 
  filter(expiryDate==m) %>%
  ggplot(aes(x=strike,y=putPrice))+
  geom_line()+
...
ggsave("`SPYdiff 1`.png",plot = `SPYdiff 1`,width = 1920, height = 1080, units = "px")
ggsave("`SPYdiff 2`.png",plot = `SPYdiff 2`,width = 1920, height = 1080, units = "px")
ggsave("`SPYdiff 3`.png",plot = `SPYdiff 3`,width = 1920, height = 1080, units = "px")
...
SPYdiffStrike <- PdiffSPY %>% 
  filter(strike==325) %>% 
  ggplot(aes(x=expiryDate,y=diffSPYput))+
  geom_line()+
  ggtitle("Trend of SPYput price diff with increasing ttm when strike = 325")
ggsave("`SPYdiffStrike`.png",plot = `SPYdiffStrike`,width = 1920, height = 1080, units = "px")
...
SPYdiff <- plotAllSPYput+plot_layout(ncol = 6)+
  plot_annotation(title = 'Diff between SPY optiong market price and Tree price of all ExpiryDates',subtitle =paste("red line is the spotunderlying price=",spotUnderlyingSPY) )
